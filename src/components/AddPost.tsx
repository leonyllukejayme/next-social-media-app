...
const AddPost = () => {
    ...
    return (
        <div className="p-4 bg-white rounded-lg flex gap-4 justify-between text-sm">
            {/* AVATAR */}
            <Image src='https://upload.wikimedia.org/wikipedia/en/1/1f/Beavis_BeavisandButtHead.png' alt="" width={40} height={40}className="w-12 h-12 object-cover rounded-full" />
            {/* POST */}
